...
//		$page_part = $requested_page_parts[count($requested_page_parts)-1];
	...
	private static function flattenConfigPathMappings(array $mappings, array $base=[]) {
		...
		foreach($mappings as $mapping) {
			if ($mapping instanceof LegacyConfig) $mapping = $mapping->toArray();
	...
	private function doUrlRemapping() {
		...
		if ($config_path_mappings instanceof LegacyConfig) $config_path_mappings = $config_path_mappings->toArray();
