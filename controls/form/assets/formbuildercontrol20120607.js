			...
			if (field_type = data.fieldTypes[field_type_id]) {
				...
				*/
				...
				// Otherwise append the field to the end of the form
					...
					var $new_field = $('<div />').text('New Field').addClass('form-builder-new-field editable-highlight editable-clickable');
					$new_field.click(function() {
				...
				$field_controls.append($input);
				$field_controls.append($a);
